...
class _TargetPageState extends State<TargetPage> {
  ...
  Future<void> _scheduleNotifications({
    ...
    final morningMessage = type == 'income'
        ? 'Good morning! 💪 Time to log your income and move closer to your financial goals!'
        : "Hey there! 🚀 Don't forget to track your expenses today – stay on budget and crush your targets!";

    final afternoonMessage = type == 'income'
        ? 'Time to boost your income again! 📈 Keep pushing toward your goal of $nominal.'
        : 'Expense check-in time! 💸 Stay within your $nominal limit for $info.';
    ...
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        title: type == 'income' ? 'Income Target Reminder' : 'Expense Target Reminder',
        body: morningMessage,
        notificationLayout: NotificationLayout.Default,
        category: NotificationCategory.Reminder,
        color: const Color(0xFF058240),
